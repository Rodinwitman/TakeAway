...
import { useInscription } from './useInscriptionActions';

type RegisterFormProps = {
    onSwitch: () => void
}

const Inscription = ({onSwitch}: RegisterFormProps) => {
    const { form, loading, showPassword, inscription, handleShowPassword } = useInscription()
    return (
                ...
                <Form {...form}>
                    <div className="mt-4 space-y-4">
                        ...
                        <SubmitButton
                            loading={loading}
                            text="S'inscrire"
                            onClick={form.handleSubmit(inscription)}
                        />
