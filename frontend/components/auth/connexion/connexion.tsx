'use client'
import { useConnexion } from './useActions';
import {
    Form,
    FormControl,
    FormField,
...
const Connexion = ({ onSwitch }: LoginFormProps) => {
    const { form, loading, showPassword, connexion, handleShowPassword } = useConnexion()
    return (
                ...
                <Form {...form}>
                    <div className='mt-4 space-y-4'>
                        ...
                        <SubmitButton
                            loading={loading}
                            text="Se connecter"
                            onClick={form.handleSubmit(connexion)}
                        />
